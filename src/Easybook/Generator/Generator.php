...
abstract class Generator
{
     ...
     *
     * @param string|string[] $skeletonDir  The directory where the templates are located
     ...
     */
    protected function renderFile($skeletonDir, string $template, string $target, $parameters): int
    {
